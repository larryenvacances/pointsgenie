  ...
  render() {
    return (
      <div className="faq">
        ...
        <blockquote>La valeur d’un Point Génie sera seulement connue au mois de novembre 2017, car la valeur du Point Génie est calculée en fonction du montant total accumulé par la promotion finissante.</blockquote>
        ...
        Pour plus d'information sur l'affichage des postes, vous référer à la charte de la 59e promotion.</blockquote>
        
        <h4>Sortie de l’horaire d’un événement?</h4>
