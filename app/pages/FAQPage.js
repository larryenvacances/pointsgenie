  ...
  render() {
    return (
      <div className="faq">
        ...
        <blockquote>Pour ce qui est de la distribution des Points Génie, contacter Michelle Kinahan, Directrice Points Génie. Pour ce qui est en lien avec le fonctionnement du site web, contacter Joël Simoneau, Webmestre. </blockquote>
      </div>
    );
  }
};
